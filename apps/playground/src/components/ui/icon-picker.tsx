...
const IconPicker = React.forwardRef<React.ComponentRef<typeof PopoverTrigger>, IconPickerProps>(
    (
        ...
        const renderIcon = useCallback(
            (icon: IconData) => (
                <div
                    className="p-2 rounded-md border hover:bg-foreground/10 transition flex items-center justify-center"
                        ...
                        if (item.type === 'category') {
                            return (
                                <div
                                    key={virtualItem.key}
                                    style={itemStyle}
                                    className="top-0 bg-white z-[10000]"
                                >
        ...
        return (
            <Popover open={open ?? isOpen} onOpenChange={handleOpenChange} modal={modal}>
                ...
                <PopoverContent className="w-64 p-2 z-[10000] relative bg-white">
                    {searchable && (
                        <Input
