...
export interface FitnessScoreDimensions {
...
export interface PortfolioFitnessScore {
    ...
    dimensions: FitnessScoreDimensions;
}
...
export interface UniqueNumbers {
    daysInvested: number;
    dailyEarnings: number;
    bestDayGain: number | null; // null for Phase 1 (needs NAV series)
    investorType: InvestorType;
    costOfInaction: number;
    loyaltyBadge: LoyaltyBadge | null;
}
...
export interface DashboardData {
    ...
    fitnessScore: PortfolioFitnessScore | null;
    uniqueNumbers: UniqueNumbers | null;
}
